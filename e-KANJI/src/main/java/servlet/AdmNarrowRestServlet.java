...
/**
 * Servlet implementation class AdmNarrowRestServlet
 */
@WebServlet("/adm-narrow-rest-servlet")
public class AdmNarrowRestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdmNarrowRestServlet() {
        super();

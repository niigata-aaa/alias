...
/**
 * Servlet implementation class PartInsertCheckServlet
 */
@WebServlet("/part-insert-check")
public class PartInsertCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PartInsertCheckServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// リクエストの転送
		RequestDispatcher rd = request.getRequestDispatcher("part-insert-check.jsp");
